...
class BaseTestMonkeybleCallback(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.ansible_task_test.loop = None
        self.ansible_task_test.loop_control = MagicMock
        self.ansible_task_test.loop_control.loop_var = "item"

        self.ansible_task_test_2 = MagicMock()
        self.ansible_task_test_2.loop = None
        self.ansible_task_test_2.loop_control = MagicMock
        self.ansible_task_test_2.loop_control.loop_var = "item"
